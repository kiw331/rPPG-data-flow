...
#
# [실행 방법]
#   python rPPG_Qt_Basic.py            # 기본값: setting\camera_settings.json 불러오기
#   python rPPG_Qt_Basic.py --reset    # UserSet 초기값으로 시작 (camera_settings.json 무시)
...
class MainWindow(QMainWindow):
    ...
    def sync_ui_with_camera(self, cam_init):
        ...
        if self.saved_cam_settings is not None:
            ...
            # --reset 모드 또는 파일 없음: UserSet 초기값 표시
