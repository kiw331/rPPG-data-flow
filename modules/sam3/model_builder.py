...
# SAM3InteractiveImagePredictor is imported lazily inside build_sam3_image_model
# to avoid pulling in pycocotools / sam3.train dependencies on Windows.
...
def build_sam3_image_model(
    ...
    if enable_inst_interactivity:
        from sam3.model.sam1_task_predictor import SAM3InteractiveImagePredictor  # lazy import
